    ...
    <div className="space-y-6">
      ...
      <div className="space-y-2 text-center lg:text-left">
        ...
        <p className="text-sm text-muted-foreground">
          Enter your login credentials to access your developer console
        </p>
      </div>
      ...
      <div className="grid grid-cols-2 gap-3">
        <Button 
          type="button" 
          variant="outline" 
          className="w-full gap-2 cursor-pointer h-9 text-xs"
          onClick={() => {
            navigate("/dashboard")
          }}
        >
      ...
      <div className="relative flex py-2 items-center">
        ...
        <span className="flex-shrink mx-4 text-[10px] text-muted-foreground font-semibold tracking-wider uppercase">
          Or continue with
        </span>
        <div className="flex-grow border-t border-border/40"></div>
      </div>
